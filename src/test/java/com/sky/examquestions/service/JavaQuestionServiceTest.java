...
public class JavaQuestionServiceTest {
    ...
    public void setUp() {
        ...
        question1 = out.add("QuestionText1", "QuestionAnswer1");
    }
    ...
    public void addOneQuestionWithAnswerTwiceTesting() {
        ...
        out.add("QuestionText1", "QuestionAnswer1");
    ...
    public void getRandomQuestionTesting() {
        ...
        out.add(new Question("QuestionText", "QuestionAnswer"));
        out.add(new Question("QuestionText2", "QuestionAnswer2"));
        out.add(new Question("QuestionText3", "QuestionAnswer3"));
